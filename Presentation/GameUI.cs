...
namespace TicTacToeGame.Presentation
{
    internal class GameUI
    {
        ...
        public static void StartGame(Player player1,Player player2)
        {
            ...
            Console.WriteLine($"Who Will Play The First Turn : 1.{player1.PlayerName} " +
            ...
            while (gameActive)
            {
                Console.WriteLine($"{activePlayer.PlayerName}'s Turn. Sign of Player is : {activePlayer.Symbol} Enter Position 1 to 9 only\n" +
